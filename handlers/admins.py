...
@Client.on_message(command(["pause", "rukja", f"ايقاف", "يقاف"]) & other_filters)
@errors
...
@Client.on_message(command(["resume", f"استئناف", "ستئناف"]) & other_filters)
@errors
@authorized_users_only
...
@Client.on_message(command(["end", " stop", f"نهاء", "انهاء"]) & other_filters)
@errors
@authorized_users_only
...
@Client.on_message(command(["skip", "next", f"تخطي", "خطي"]) & other_filters)
@errors
@authorized_users_only
